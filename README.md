...
```lua
 local sessions = wezterm.plugin.require("https://github.com/abayomi185/wezterm-sessions")
...
Fork of the original [WezTerm Session Manager](https://github.com/danielcopper/wezterm-session-manager) created by [Daniel Copper](https://github.com/danielcopper).
